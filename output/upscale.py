...
def get_max_workers(
    avg_vram_per_worker, vram_buffer=512
):  # Adjust dynamically based on avg VRAM
    gpus = GPUtil.getGPUs()
    if gpus:
...
avg_vram_per_worker = calculate_average_vram_usage(samples=50)
