(async () => {
    ...
    const uniqueAudioFormats = Array.from(
        ...
        audioFormats.find((format) => format.itag === itag)
    ...
    uniqueAudioFormats.forEach((format) => {
        ...
        console.log(`itag: ${format.itag}, container: ${format.container}, audioBitrate: ${format.audioBitrate}, audioSampleRate: ${format.audioSampleRate}, audioCodec: ${format.audioCodec}, contentLength: ${contentLengthMB} MB`);
    });
})();
